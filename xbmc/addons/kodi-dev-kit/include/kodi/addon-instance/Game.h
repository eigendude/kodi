...
private:
  ...
  inline static GAME_ERROR ADDON_ReplaceImageIndex(const AddonInstance_Game* instance,
                                                   ...
                                                   const char* filePath)
  {
    return static_cast<CInstanceGame*>(instance->toAddon->addonInstance)->ReplaceImageIndex(imageIndex, filePath ? filePath : "");
  }

  inline static GAME_ERROR ADDON_RemoveImageIndex(const AddonInstance_Game* instance,
                                                  unsigned int imageIndex)
  {
    return static_cast<CInstanceGame*>(instance->toAddon->addonInstance)->RemoveImageIndex(imageIndex);
  }
  ...
  inline static GAME_ERROR ADDON_SetInitialImage(const AddonInstance_Game* instance,
                                                 ...
                                                 const char* filePath)
  {
    return static_cast<CInstanceGame*>(instance->toAddon->addonInstance)->SetInitialImage(imageIndex, filePath ? filePath : "");
  }
  ...
  inline static char* ADDON_GetImageLabel(const AddonInstance_Game* instance,
                                          unsigned int imageIndex)
  {
    std::string cppLabel = static_cast<CInstanceGame*>(instance->toAddon->addonInstance)->GetImageLabel(imageIndex);
    if (cppLabel.empty())
      return nullptr;
