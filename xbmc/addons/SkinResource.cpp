...
bool CSkinResource::IsAllowed(const std::string& file) const
{
  ...
  return file.empty() ||
         StringUtils::EqualsNoCase(ext, ".xml") ||
         StringUtils::EqualsNoCase(ext, ".png") ||
         StringUtils::EqualsNoCase(ext, ".jpg") ||
         StringUtils::EqualsNoCase(ext, ".jpeg") ||
         StringUtils::EqualsNoCase(ext, ".gif") ||
         StringUtils::EqualsNoCase(ext, ".bmp") ||
         StringUtils::EqualsNoCase(ext, ".dds") ||
         StringUtils::EqualsNoCase(ext, ".tga") ||
         StringUtils::EqualsNoCase(ext, ".ttf") ||
         StringUtils::EqualsNoCase(ext, ".otf") ||
         StringUtils::EqualsNoCase(ext, ".ttc");
}
