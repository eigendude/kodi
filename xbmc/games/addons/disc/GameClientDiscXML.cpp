...
bool CGameClientDiscXML::SaveM3U(const std::string& gamePath, const CGameClientDiscModel& model) const
{
  return CGameClientDiscM3U::Save(gamePath, model);
}
