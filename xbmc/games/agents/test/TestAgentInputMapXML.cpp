...
// These unit tests validate XML serialization of agent input maps
// and the error handling for malformed documents.
 ...
 * The ID, game client and digest are set so the topology behaves
 * like a real-world definition.
 */
 ...
 *
 * A sample topology is converted to XML and parsed back. Every
 * property of the resulting topology should match the original
 * object.
 */
 ...
 *
 * The map should contain the same entries after deserialization and
 * allow lookup by both ID and digest.
 */
