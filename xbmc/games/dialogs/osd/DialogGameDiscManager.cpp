...
void CDialogGameDiscManager::InitializeGameClient()
{
  if (m_gameClient)
  {
...
void CDialogGameDiscManager::InitializeDialog()
{
  ...
  {
    discMgrMenu->SetListProvider(std::make_unique<CDiscManagerMenu>(m_gameClient, *m_discActions,
