...
TEST(TestControllerDigest, NestedHub)
{
  ...
  ADDON::AddonInfoPtr addonInfo1 =
      std::make_shared<ADDON::CAddonInfo>("game.controller.parent", ADDON::AddonType::GAME_CONTROLLER);
  ControllerPtr controller1 = std::make_shared<CController>(addonInfo1);

  ADDON::AddonInfoPtr addonInfo2 =
      std::make_shared<ADDON::CAddonInfo>("game.controller.child", ADDON::AddonType::GAME_CONTROLLER);
  ControllerPtr controller2 = std::make_shared<CController>(addonInfo2);
