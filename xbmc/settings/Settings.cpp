...
const std::string CSettings::SETTING_AIR_QUALITY_ADDON = "airquality.addon";
const std::string CSettings::SETTING_AIR_QUALITY_ADDONSETTINGS = "airquality.addonsettings";
