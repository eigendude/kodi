...
#define ACTION_FORWARD \
  16 //!< Can be used to specify specific action in a window, Playback control is handled in ACTION_PLAYER_*
#define ACTION_REWIND \
  17 //!< Can be used to specify specific action in a window, Playback control is handled in ACTION_PLAYER_*
...
#define ACTION_GESTURE_ZOOM \
  502 //!< sendaction with point and currentPinchScale (fingers together < 1.0 -> fingers apart > 1.0)
