...
public:
  ...
  bool GetFeature(const CDriverPrimitive& primitive, FeatureName& feature) override
  {
    ...
    if (primitive.Type() == PRIMITIVE_TYPE::BUTTON &&
        primitive.MouseButton() == BUTTON_ID::LEFT)
    {
      feature = "left_button";
      return true;
    }
  ...
  FEATURE_TYPE GetFeatureType(const FeatureName&) override
  {
    return FEATURE_TYPE::RELATIVE_POINTER;
  }
  ...
  bool GetAnalogStick(const FeatureName&, ANALOG_STICK_DIRECTION, CDriverPrimitive&) override { return false; }
  void AddAnalogStick(const FeatureName&, ANALOG_STICK_DIRECTION, const CDriverPrimitive&) override {}

  bool GetRelativePointer(const FeatureName& feature, RELATIVE_POINTER_DIRECTION direction, CDriverPrimitive& primitive) override
  {
    if (feature == "pointer")
    {
  ...
  void AddRelativePointer(const FeatureName&, RELATIVE_POINTER_DIRECTION, const CDriverPrimitive&) override {}
  bool GetAccelerometer(const FeatureName&, CDriverPrimitive&, CDriverPrimitive&, CDriverPrimitive&) override { return false; }
  void AddAccelerometer(const FeatureName&, const CDriverPrimitive&, const CDriverPrimitive&, const CDriverPrimitive&) override {}
  ...
  bool GetThrottle(const FeatureName&, THROTTLE_DIRECTION, CDriverPrimitive&) override { return false; }
