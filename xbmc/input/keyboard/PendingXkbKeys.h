...
/*!
 * \brief Temporary key names for pending additions to xorgproto
 *
 * These values match Linux input-event keycodes. Once upstream names stabilize
 * these constants should be replaced by the official XF86 definitions.
 *
 * @todo Switch to upstream names when the MR is merged and released:
